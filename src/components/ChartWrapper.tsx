    ...
    return (
      <div className={`flex items-center justify-center bg-slate-50/50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 ${className}`}>
        <div className="text-center p-4">
          ...
          <p className="text-sm font-bold text-slate-700 dark:text-slate-200">No Assessment Data Available</p>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">
            Enter and approve assessment marks to generate the grade distribution.
          </p>
        </div>
      </div>
    );
