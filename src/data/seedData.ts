...
export const initialSchool: School = {
  ...
  county: 'Nyandarua',
  postal_code: 'P.O. Box 123-20318',
  address: 'Muchorwe, Kenya',
...
export const initialSubjects: Subject[] = [
  // --- PRE-PRIMARY (PP1 & PP2) ---
  { id: 'sb_pp_lang', subject_name: 'Language Activities', subject_code: 'LANG ACT', category: 'Activity', department: 'Pre-Primary', education_level: 'Pre-Primary', applicable_grades: ['PP1', 'PP2'], status: 'Active' },
  { id: 'sb_pp_math', subject_name: 'Mathematical Activities', subject_code: 'MATH ACT', category: 'Activity', department: 'Pre-Primary', education_level: 'Pre-Primary', applicable_grades: ['PP1', 'PP2'], status: 'Active' },
  { id: 'sb_pp_env', subject_name: 'Environmental Activities', subject_code: 'ENV ACT', category: 'Activity', department: 'Pre-Primary', education_level: 'Pre-Primary', applicable_grades: ['PP1', 'PP2'], status: 'Active' },
  { id: 'sb_pp_psy', subject_name: 'Psychomotor & Creative Activities', subject_code: 'PSYCH ACT', category: 'Activity', department: 'Pre-Primary', education_level: 'Pre-Primary', applicable_grades: ['PP1', 'PP2'], status: 'Active' },
  { id: 'sb_pp_re', subject_name: 'Christian Religious Education', subject_code: 'CRE', category: 'Activity', department: 'Pre-Primary', education_level: 'Pre-Primary', applicable_grades: ['PP1', 'PP2'], status: 'Active' },

  // --- LOWER PRIMARY (Grade 1 - 3) ---
  { id: 'sb_lp_eng', subject_name: 'English Language Activities', subject_code: 'ENG LP', category: 'Core', department: 'Languages', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },
  { id: 'sb_lp_kis', subject_name: 'Kiswahili Language Activities', subject_code: 'KIS LP', category: 'Core', department: 'Languages', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },
  { id: 'sb_lp_mat', subject_name: 'Mathematical Activities', subject_code: 'MAT LP', category: 'Core', department: 'STEM', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },
  { id: 'sb_lp_env', subject_name: 'Environmental Activities', subject_code: 'ENV LP', category: 'Core', department: 'Humanities', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },
  { id: 'sb_lp_hng', subject_name: 'Hygiene and Nutrition', subject_code: 'HNG LP', category: 'Core', department: 'Applied Sciences', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },
  { id: 'sb_lp_crt', subject_name: 'Creative Activities', subject_code: 'CREAT LP', category: 'Core', department: 'Technical & Arts', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },
  { id: 'sb_lp_re', subject_name: 'Christian Religious Education', subject_code: 'CRE', category: 'Core', department: 'Humanities', education_level: 'Lower Primary', applicable_grades: ['Grade 1', 'Grade 2', 'Grade 3'], status: 'Active' },

  // --- UPPER PRIMARY (Grade 4 - 6) ---
  { id: 'sb_up_eng', subject_name: 'English Language', subject_code: 'ENG UP', category: 'Core', department: 'Languages', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  { id: 'sb_up_kis', subject_name: 'Kiswahili Language', subject_code: 'KIS UP', category: 'Core', department: 'Languages', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  { id: 'sb_up_mat', subject_name: 'Mathematics', subject_code: 'MAT UP', category: 'Core', department: 'STEM', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  { id: 'sb_up_sci', subject_name: 'Science and Technology', subject_code: 'SCI UP', category: 'Core', department: 'STEM', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  { id: 'sb_up_agr', subject_name: 'Agriculture & Nutrition', subject_code: 'AGR UP', category: 'Core', department: 'Applied Sciences', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  { id: 'sb_up_sst', subject_name: 'Social Studies', subject_code: 'SST UP', category: 'Core', department: 'Humanities', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  { id: 'sb_up_crt', subject_name: 'Creative Arts', subject_code: 'CREAT UP', category: 'Core', department: 'Technical & Arts', education_level: 'Upper Primary', applicable_grades: ['Grade 4', 'Grade 5', 'Grade 6'], status: 'Active' },
  ...
  { id: 'sb_mat', subject_name: 'Mathematics', subject_code: 'MAT', category: 'Core', department: 'STEM', education_level: 'Junior School', applicable_grades: ['Grade 7', 'Grade 8', 'Grade 9'], status: 'Active' },
  { id: 'sb_sci', subject_name: 'Integrated Science', subject_code: 'SCI', category: 'Core', department: 'STEM', education_level: 'Junior School', applicable_grades: ['Grade 7', 'Grade 8', 'Grade 9'], status: 'Active' },
  ...
  { id: 'sb_agn', subject_name: 'Agriculture and Nutrition', subject_code: 'AGN', category: 'Core', department: 'Applied Sciences', education_level: 'Junior School', applicable_grades: ['Grade 7', 'Grade 8', 'Grade 9'], status: 'Active' },
  ...
  { id: 'sb_hed', subject_name: 'Health Education', subject_code: 'HED', category: 'Core', department: 'Applied Sciences', education_level: 'Junior School', applicable_grades: ['Grade 7', 'Grade 8', 'Grade 9'], status: 'Archived' },
  { id: 'sb_bst', subject_name: 'Business Studies', subject_code: 'BST', category: 'Elective', department: 'Humanities', education_level: 'Junior School', applicable_grades: ['Grade 7', 'Grade 8', 'Grade 9'], status: 'Archived' },
  { id: 'sb_cs', subject_name: 'Computer Science', subject_code: 'CS', category: 'Elective', department: 'STEM', education_level: 'Junior School', applicable_grades: ['Grade 7', 'Grade 8', 'Grade 9'], status: 'Archived' },
];
...
export const initialClasses: ClassStream[] = [
  ...
  // Lower Primary
  { id: 'cls_g1_b', class_name: 'Grade 1', stream: 'Blue', capacity: 35, education_level: 'Lower Primary', status: 'Active', allocated_subject_ids: ['sb_lp_eng', 'sb_lp_kis', 'sb_lp_mat', 'sb_lp_env', 'sb_lp_crt', 'sb_lp_re'] },
  { id: 'cls_g2_b', class_name: 'Grade 2', stream: 'Blue', capacity: 35, education_level: 'Lower Primary', status: 'Active', allocated_subject_ids: ['sb_lp_eng', 'sb_lp_kis', 'sb_lp_mat', 'sb_lp_env', 'sb_lp_crt', 'sb_lp_re'] },
  { id: 'cls_g3_b', class_name: 'Grade 3', stream: 'Blue', capacity: 35, education_level: 'Lower Primary', status: 'Active', allocated_subject_ids: ['sb_lp_eng', 'sb_lp_kis', 'sb_lp_mat', 'sb_lp_env', 'sb_lp_crt', 'sb_lp_re'] },
...
export const initialSubjectGroups: SubjectGroup[] = [
  {
    id: 'grp_up_eng',
    group_name: 'English',
    group_code: 'ENG',
    ...
    display_order: 1,
    is_active: true,
    subject_ids: ['sb_up_eng'],
  },
  {
    id: 'grp_up_kis',
    group_name: 'Kiswahili',
    group_code: 'KIS',
    education_level: 'Upper Primary',
    display_order: 2,
    is_active: true,
    subject_ids: ['sb_up_kis'],
  },
  {
    id: 'grp_up_mat',
  ...
  },
  {
    ...
    display_order: 4,
    is_active: true,
    subject_ids: ['sb_up_sci'],
  },
  {
    id: 'grp_up_sst',
    group_name: 'Social Studies',
    group_code: 'SST',
    education_level: 'Upper Primary',
    display_order: 5,
    is_active: true,
    subject_ids: ['sb_up_sst'],
  },
  {
    id: 'grp_up_agr',
    ...
    display_order: 6,
    is_active: true,
    subject_ids: ['sb_up_agr'],
  },
  {
    id: 'grp_up_cre',
    group_name: 'Christian Religious Education',
    group_code: 'CRE',
    education_level: 'Upper Primary',
    display_order: 7,
    is_active: true,
    subject_ids: ['sb_up_re'],
  },
  {
    id: 'grp_up_ca',
    group_name: 'Creative Arts',
    group_code: 'CA',
    education_level: 'Upper Primary',
    display_order: 8,
    is_active: true,
    subject_ids: ['sb_up_crt'],
  },
];
